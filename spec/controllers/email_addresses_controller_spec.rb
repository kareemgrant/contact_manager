...
#         post :create, {:email_address => {  }}, valid_session
#         assigns(:email_address).should be_a_new(EmailAddress)
#       end
...
#         EmailAddress.any_instance.should_receive(:update_attributes).with({ "these" => "params" })
#         put :update, {:id => email_address.to_param, :email_address => { "these" => "params" }}, valid_session
#       end
...
#         # Trigger the behavior that occurs when invalid params are submitted
#         EmailAddress.any_instance.stub(:save).and_return(false)
#         put :update, {:id => email_address.to_param, :email_address => {  }}, valid_session
#         assigns(:email_address).should eq(email_address)
#       end
